...
class Student {
    ...
    public boolean hasSubmitted(String className, String assignmentName) 
    {
        return submissions.getOrDefault(className, Collections.emptySet()).contains(assignmentName);
    }
}
